...
namespace LMS.Controls.Courses
{
    public partial class Courses : UserControl
    {
        ...
        {
            LoadDataIntoDataGridView("Select * from StudentCourseEnrollment where status='active'", dataGridView2);
        }
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    comboBox5.Text = row.Cells["studentID"].Value.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        {
            string updateQuery = "UPDATE StudentCourseEnrollment SET Status = 'Inactive' WHERE enrollmentid = @enrollmentid";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!int.TryParse(comboBox5.Text, out int studentID) || studentID <= 0)
                {
                ...
                using (SqlConnection connection = new SqlConnection(ConnectionString))
                {
                    ...
                    string insertQuery = @"
            INSERT INTO StudentCourseEnrollment (StudentID, CourseID, ClassID, SectionID, TermID, Status, CreatedAt, UpdatedAt)
            VALUES (@StudentID, @CourseID, @ClassID, @SectionID, @TermID, 'Active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                int studentID = int.Parse(comboBox5.Text);
                ...
                using (SqlConnection connection = new SqlConnection(ConnectionString))
                {
                    ...
                    string updateQuery = "UPDATE StudentCourseEnrollment SET StudentID=@StudentID, CourseID=@CourseID, ClassID=@ClassID, SectionID=@SectionID, TermID=@TermID WHERE EnrollmentID = @EnrollmentID";
